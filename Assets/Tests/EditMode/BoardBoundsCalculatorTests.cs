...
namespace Game.Tests
{
    public class BoardBoundsCalculatorTests
    {
        ...
        {
            var bounds = BoardBoundsCalculator.Compute(cameraPosition: new Vector2(2f, 3f), boardWidth: 8f, orthographicSize: 5f);
        ...
        {
            var bounds = BoardBoundsCalculator.Compute(cameraPosition: new Vector2(0f, 0f), boardWidth: 8f, orthographicSize: 5f);
